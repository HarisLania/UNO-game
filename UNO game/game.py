                    ...
                    if ask == 'y':
                        try:
                            ...
                            if card_name in player.keys():
                                if player[card_name][-3:] == self.card[-3:] or player[card_name][-4:] == self.card[-4:] or player[card_name][-5:] == self.card[-5:] or player[card_name] == 'wild' or player[card_name] == 'draw_four':
